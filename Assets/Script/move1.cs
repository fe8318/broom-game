  ...
  private Coroutine cor_canJump_dead;
	...
	private void Movement()//方法
      ...
      if(touchGround)
      {
          ...
          this.gameObject.transform.Translate(new Vector2(moveSpeed*Input.GetAxis("Horizontal"), 0) * Time.deltaTime);
          rb2d.AddForce(Vector2.right * Input.GetAxis("Horizontal") * 1);
      }
      else
      {
